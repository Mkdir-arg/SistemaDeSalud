...
- `SALUD_URL=http://127.0.0.1:18990 node node_modules/@playwright/test/cli.js test --config=playwright.finanzas-ui.config.js --output=C:/Users/Juanito/AppData/Local/Temp/finanzas-dinero-final-ui-20260914`: **57 tests OK**, 1,5min (45 existentes + 12 dinero). Contratos HTTP simulados; no prueba integración por sí sola.

...
/*
 * Registro de accesos a datos de pacientes, incluida la actividad consultada por financiadores.
 *
...
const TIPOS = [
  ...
  { value: "financiador", label: "Consulta de un financiador" },
];
    ...
    <div className="px-lg py-[26px] sm:px-[30px]">
      ...
      <TablaRecurso
        ...
        vacio={{
          ...
          detalle: activos
            ? "Probá con el apellido o el documento del paciente, o con el nombre del usuario. También podés ampliar el rango de fechas."
            : "Acá aparecen las consultas a datos clínicos y a la actividad hospitalaria de afiliados.",
        }}
        columnas={[
          {

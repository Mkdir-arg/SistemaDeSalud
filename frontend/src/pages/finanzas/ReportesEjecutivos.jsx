...
import { Badge, Card, Input, Modal, Select, Spinner } from "@/components/ui";
...
export default function ReportesEjecutivos({ institucion, permisos, mes, area, onGastos }) {
  ...
  return <section className="finance-report" aria-label="Reportes ejecutivos">
    ...
    {permisos.tiene("ver_gastos") ? <Consulta consulta={gastos}>{(d) => <section aria-label="Informe de gastos" className="finance-report-section">
      ...
      <SerieMensual reporte={d} medidas={medidasGastos} onAbrir={abrirGasto} />
      <Card className="finance-report-panel finance-report-charts">
        ...
        <TablaAgregadaFinanzas clave="reporte_grupos_gastos" titulo="Comparación exacta de gastos"
          ...
          columnas={[
            ...
            { key: "variacion", label: "Variación nominal", numerica: true, valor: (g) => g.variacion?.importe, render: (g) => <Variacion dato={g.variacion} /> },
          ]} />
      </Card>

...
function EspacioFinanciador({ organizacion, usuarioId, plataforma, tab }) {
  ...
  return <>
    ...
    <section aria-label={SECCIONES.find((item) => item.key === tab)?.label}>
      ...
      {tab === "actividad" ? <ActividadFinanciador organizacion={organizacion} scope={scope} /> : <ListaPortal key={tab} recurso={tab} organizacion={organizacion} scope={scope} admin={admin} operador={operador} planes={planes.data || []} catalogo={catalogo.data || []} actualizado={actualizado} />}
    </section>

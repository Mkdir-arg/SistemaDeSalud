...
function EspacioHospital({ usuarioId, institucion }) {
  ...
  return <div className="space-y-5 p-4 sm:p-8">
    <div className="flex flex-wrap items-start justify-between gap-3"><div><div className="flex items-center gap-2"><h1 className="text-xl font-bold">Coberturas y copagos</h1><Ayuda>{institucion.nombre} · Cobertura por prestación, reservas compartidas y saldos a resolver.</Ayuda></div></div><Link to="/finanzas" className="text-sm font-semibold text-accent hover:underline">Finanzas y cobros</Link></div>

...
export const DEMO_STEPS = [
  {
    ...
    guion: [
      ...
      { t: "elegir", campo: "Tipo", opcion: "Otro", decir: "Elegimos un tipo particular" },
      { t: "escribir", campo: "Especificá el tipo", valor: "Hospital general de capacitación", decir: "Qué tipo de establecimiento es" },
  ...
  },
  {
    ...
    guion: [
      ...
      { t: "escribir", campo: "Contraseña", valor: "EscuelaSalud2026!", decir: "Contraseña inicial" },
      { t: "escribir", campo: "Confirmar contraseña", valor: "EscuelaSalud2026!", decir: "Confirmamos la contraseña" },
